...
BEGIN
	...
	SET @Master_TypesTable = N'CREATE TABLE [AccountHub].[dbo].[##MASTER##Types](
	...
	SET @Master_StatusTable = N'CREATE TABLE [AccountHub].[dbo].[##MASTER##Status] (
							[SysId] [int] IDENTITY(1,1) NOT NULL,
							[PublicId] [uniqueidentifier] NOT NULL,
							[Path] [varchar](1024) NOT NULL,
							[CreateDate] [datetime] NOT NULL,
	...
	DECLARE @Master_Table VARCHAR(MAX) 
	 SET @Master_Table = N'CREATE TABLE [AccountHub].[dbo].[##MASTER##s] (
	[SysId] [int] IDENTITY(1,1) NOT NULL,
