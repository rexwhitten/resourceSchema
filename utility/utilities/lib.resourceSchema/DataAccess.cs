...
namespace resourceSchema
{
    public partial class DataAccess : IDisposable
    {
        ...
        {
            this.CreateConnection(ConfigurationManager.ConnectionStrings[connectionStringName].ConnectionString);
            this.DatabaseName = this.Connection.Database;
        }
        ...
        public virtual DataSet ExecuteSql(String Sql)
        {
            if ((Connection == null))
            {
                throw new DataAccessException(this.connectionString, this.commandText, "Call CreateConnection method before using the connection.", null);
            }
            this.Command = new SqlCommand(Sql, this.Connection);
            SqlDataAdapter da = null;
            DataSet ds;
        ...
        public virtual List<Hashtable> ExecuteHash(string Sql, params object[] pars)
        {
            ...
            {
                throw new DataAccessException(this.connectionString, this.commandText, "Call CreateConnection method before using the connection.", x);
            }
            finally
            {
