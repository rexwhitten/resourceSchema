namespace resourceSchema.Bll {
    ...
    public partial class Teamstatus {
        ...
        public virtual TeamsCollection TeamsCollection {
            get {
                if ((this._teamsCollection == null)) {
                    _teamsCollection = resourceSchema.Bll.Teams.Select_Teamss_By_TeamStatusSysId(this.Sysid);
                }
        ...
        public static TeamstatusCollection GetAll() {
            resourceSchema.Dal.Teamstatus dbo = null;
            try {
                dbo = new resourceSchema.Dal.Teamstatus();
                System.Data.DataSet ds = dbo.TeamStatus_Select_All();
                TeamstatusCollection collection = new TeamstatusCollection();
        ...
        public static Teamstatus Load(System.Nullable<int> SysId) {
            resourceSchema.Dal.Teamstatus dbo = null;
            try {
                dbo = new resourceSchema.Dal.Teamstatus();
                System.Data.DataSet ds = dbo.TeamStatus_Select_One(SysId);
                Teamstatus obj = null;
                if (GlobalTools.IsSafeDataSet(ds)) {
        ...
        public virtual void Load() {
            ...
            try {
                dbo = new resourceSchema.Dal.Teamstatus();
                System.Data.DataSet ds = dbo.TeamStatus_Select_One(this.Sysid);
                if (GlobalTools.IsSafeDataSet(ds)) {
                    if ((ds.Tables[0].Rows.Count > 0)) {
        ...
        public virtual void Insert() {
            ...
            try {
                dbo = new resourceSchema.Dal.Teamstatus();
                dbo.TeamStatus_Insert(this.Publicid, this.Path, this.Createdate, this.Lastmodifieddate, this.Active);
            }
            catch (System.Exception ) {
                throw;
            }
        ...
        public virtual void Delete() {
            ...
            try {
                dbo = new resourceSchema.Dal.Teamstatus();
                dbo.TeamStatus_Delete(this.Sysid);
            }
            catch (System.Exception ) {
                throw;
            }
        ...
        public virtual void Update() {
            ...
            try {
                dbo = new resourceSchema.Dal.Teamstatus();
                dbo.TeamStatus_Update(this.Sysid, this.Publicid, this.Path, this.Createdate, this.Lastmodifieddate, this.Active);
            }
            catch (System.Exception ) {
                throw;
            }
