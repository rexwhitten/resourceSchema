namespace resourceSchema.Bll {
    ...
    public partial class Userstatus {
        ...
        public virtual UsersCollection UsersCollection {
            get {
                if ((this._usersCollection == null)) {
                    _usersCollection = resourceSchema.Bll.Users.Select_Userss_By_UserStatusSysId(this.Sysid);
                }
        ...
        public virtual void Load() {
            ...
            try {
                dbo = new resourceSchema.Dal.Userstatus();
                System.Data.DataSet ds = dbo.UserStatus_Select_One(this.Sysid);
                if (GlobalTools.IsSafeDataSet(ds)) {
                    if ((ds.Tables[0].Rows.Count > 0)) {
        ...
        public virtual void Insert() {
            ...
            try {
                dbo = new resourceSchema.Dal.Userstatus();
                dbo.UserStatus_Insert(this.Publicid, this.Path, this.Createdate, this.Lastmodifieddate, this.Active);
            }
            catch (System.Exception ) {
                throw;
            }
        ...
        public virtual void Delete() {
            ...
            try {
                dbo = new resourceSchema.Dal.Userstatus();
                dbo.UserStatus_Delete(this.Sysid);
            }
            catch (System.Exception ) {
                throw;
            }
        ...
        public virtual void Update() {
            ...
            try {
                dbo = new resourceSchema.Dal.Userstatus();
                dbo.UserStatus_Update(this.Sysid, this.Publicid, this.Path, this.Createdate, this.Lastmodifieddate, this.Active);
            }
            catch (System.Exception ) {
                throw;
            }
