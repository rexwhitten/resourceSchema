namespace resourceSchema.Bll {
    ...
    public partial class Tasktypes {
        ...
        public virtual TasksCollection TasksCollection {
            get {
                if ((this._tasksCollection == null)) {
                    _tasksCollection = resourceSchema.Bll.Tasks.Select_Taskss_By_TaskTypeSysId(this.Sysid);
                }
        ...
        public static TasktypesCollection GetAll() {
            resourceSchema.Dal.Tasktypes dbo = null;
            try {
                dbo = new resourceSchema.Dal.Tasktypes();
                System.Data.DataSet ds = dbo.TaskTypes_Select_All();
                TasktypesCollection collection = new TasktypesCollection();
        ...
        public static Tasktypes Load(System.Nullable<int> SysId) {
            resourceSchema.Dal.Tasktypes dbo = null;
            try {
                dbo = new resourceSchema.Dal.Tasktypes();
                System.Data.DataSet ds = dbo.TaskTypes_Select_One(SysId);
                Tasktypes obj = null;
                if (GlobalTools.IsSafeDataSet(ds)) {
        ...
        public virtual void Load() {
            ...
            try {
                dbo = new resourceSchema.Dal.Tasktypes();
                System.Data.DataSet ds = dbo.TaskTypes_Select_One(this.Sysid);
                if (GlobalTools.IsSafeDataSet(ds)) {
                    if ((ds.Tables[0].Rows.Count > 0)) {
        ...
        public virtual void Insert() {
            ...
            try {
                dbo = new resourceSchema.Dal.Tasktypes();
                dbo.TaskTypes_Insert(this.Publicid, this.Path, this.Createdate, this.Lastmodifieddate, this.Active);
            }
            catch (System.Exception ) {
                throw;
            }
        ...
        public virtual void Delete() {
            ...
            try {
                dbo = new resourceSchema.Dal.Tasktypes();
                dbo.TaskTypes_Delete(this.Sysid);
            }
            catch (System.Exception ) {
                throw;
            }
        ...
        public virtual void Update() {
            ...
            try {
                dbo = new resourceSchema.Dal.Tasktypes();
                dbo.TaskTypes_Update(this.Sysid, this.Publicid, this.Path, this.Createdate, this.Lastmodifieddate, this.Active);
            }
            catch (System.Exception ) {
                throw;
            }
