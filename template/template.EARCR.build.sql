/****** Object:  StoredProcedure [meta].[Create_Masters]    Script Date: 10/7/2014 11:13:32 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [meta].[Create_Masters]
...
BEGIN
	...
	SET @Master_TypesTable = N''CREATE TABLE [dbo].[##MASTER##Types](
	...
	SET @Master_StatusTable = N''CREATE TABLE [dbo].[##MASTER##Status] (
							[SysId] [int] IDENTITY(1,1) NOT NULL,
							[PublicId] [uniqueidentifier] NOT NULL,
							[Path] [varchar](1024) NOT NULL,
							[CreateDate] [datetime] NOT NULL,
	...
	DECLARE @Master_Table VARCHAR(MAX) 
	 SET @Master_Table = N''CREATE TABLE [dbo].[##MASTER##s] (
	[SysId] [int] IDENTITY(1,1) NOT NULL,
